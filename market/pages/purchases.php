    ...
    <div class="container-fluid">
        ...
        <div class="row border bg-white rounded shadow-sm m-4">
            ...
            <div class="col-12 d-flex p-2 justify-content-end">
                ...
                <a class="btn btn-m btn-primary mb-2" href="purchase_order_details.php?new=1"><i class="bi bi-plus-circle"></i>طلبيه جديده</a>
                ...
                <div class="table-responsive vh-85 overflow-auto">
                    <table class="table table-bordered table-hover text-center align-middle" id="clickable_table">
                        ...
                        <tbody>
                            ...
                            $statement = $conn->prepare("SELECT * FROM `orders` WHERE `order_type` = 'purchases'");
                            ...
                            if ($total_row > 0) {
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <td>'.++$row_counter .'</td>
                                        ...
                                        <td><a class="btn btn-warning" href="purchase_order_details.php?id='.$row['order_id'].'">View</a></td>
