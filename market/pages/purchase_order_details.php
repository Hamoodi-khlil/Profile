...
if (isset($_GET['id'])) {
    ...
    $input_name = 'update_purchase_order';

}else{
    $input_name = 'insert_purchase_order';
}
            ...
            <div class="row border bg-white rounded shadow-sm m-4 " style="height: 83vh;">
                    ...
                    <div class="h-25 bg-light">
                        ...
                        <div class="row p-2 text-center h-100 align-items-center overflow-auto">
                           ...
                           <label for=" total_amount">الاجمالي</label>
                            ...
                            <div class="col-3">
                                <div class="form-floating mb-1">
                                    <input type="number" class="form-control form-control-lg" id="discount_percentage" name="discount_percentage" value="<?php echo isset($discount_percentage) ? $discount_percentage : '0' ?>">
                    ...
                    <div class="products border h-75  overflow-auto" style="background-color: #3f4d5e;">
                        ...
                        if ($statment->rowCount() > 0) {
                            ...
                            foreach ($result as $row) {
                                ...
                                echo '<button rami="' . $row['purchase_price'] . '"  type="button" class="btn btn-primary m-1">' . $row['product_name'] . '</button>';
                            }
                        }
                ...
                <div class="col-2  border-start" style="background-color: #3f4d5e;">
                    ...
                    <div class="d-grid gap-1">
                        ...
                        <button type="button" onclick="window.history.back(-1);" class="btn btn-dark"><i class="bi bi-reply float-start pe-2 "></i>رجوع</button>
...
<script>
    $(document).on('change', '#supplier_id', function() {
        ...
        supplier_name = $(this).find('option:selected').text();
